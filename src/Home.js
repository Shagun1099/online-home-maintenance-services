...
function Home() {
  return (
    <div className="home">
     ...
     <h1 className="home_header">Online Home Maintenance Services</h1>
	...
	<div className="home_row">
		<Service
            ...
            image={WiFi}
            rating={4}
            providerType="Wifi Service Worker"
	...
	<div className="home_row">
          <Service
            ...
            rating={4}
            image={San}
            providerType="Sanitisation Worker"
		  ...
		  <Service
            ...
            rating={4}
            image={Pest}
            providerType="Pest Control Worker"
		  ...
		  <Service
            ...
            rating={5}
            image={Cle}
            providerType="Cleaning Service Worker"
	...
	<div className="home_row">
		...
		<Service
            ...
            title="Mobile-Repair"
            rating={4}
            providerType="Mobile Repair Worker"
            image={Mob}
	...
	<div className="home_row">
		 <Service
            ...
            rating={5}
            image={Cab}
            providerType="Cable Service Worker"
